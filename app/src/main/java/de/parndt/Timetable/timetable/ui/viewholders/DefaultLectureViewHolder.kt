...
import kotlinx.android.synthetic.main.list_item_default_lecture.view.*
import java.time.LocalDate

class DefaultLectureViewHolder private constructor(view: View, private val context: Context) : RecyclerView.ViewHolder(view) {
    ...
    companion object {
        fun from(parent: ViewGroup, context: Context): DefaultLectureViewHolder {
            val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.list_item_default_lecture, parent, false)

            return DefaultLectureViewHolder(
                view,
                context
            )
        }
